...
public class Person {
	...
	/**
	 * Constructs a default person with a name of Steve Rogers, relation of client,
	 * and birthday of January 1st, 2000
	 */
	public Person() {
	 ...
	 * @param personFirstName
	 *            First name of the person
	 * @param personMiddleInitial
	 *            Middle initial of the person
	 * @param personLastName
	 *            Last name of the person
	 * @param personRelation
	 *            Relation of the person to the client
	 * @param personBirthday
	 *            Birthday of the person
	 * @param primaryClient
	 *            Whether or not this client is the primary client
	 */
	 ...
	 * 
	 * @param client
	 *            Whether or not this is the primary client
	 */
	 ...
	 * 
	 * @param o
	 *            Object the person is being compared to
	 * 
